...
(async () => {
  ...
  const saveRes = await page.evaluate(async () => {
    const payload = {
      project_name: '前台真验-gmp_workshop',
      report_number: 'PDJC-BG2026-19WEB-GMP1',
      client_name: '前台真验客户',
      contact_info: '13800000000',
      project_address: '上海市浦东新区测试路1号',
      inspection_area: '前台真验GMP车间',
      detection_date: '2026-05-03',
      detection_state: '静态',
      weather: { temperature: '22', humidity: '50', pressure: '1013' },
      domain: 'pharma',
      domain_name: '制药工业',
      detection_type: 'gmp_workshop',
      detection_type_name: 'GMP车间',
      basis: ['GB 50591-2010'],
      ...
      rooms: [{
        ...
        summary: {
          ...
          judgement_engine: 'gmp_workshop_v1',
  ...
  const pngName = `frontend_restore_gmp_workshop_${stamp}_gmp_workshop.png`;
  const jsonName = `frontend_restore_gmp_workshop_${stamp}_gmp_workshop.json`;
