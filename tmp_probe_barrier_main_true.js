...
(async () => {
  ...
  const stamp='20260503_1823_barrier_main_true';
  ...
  const saveRes = await page.evaluate(async () => {
    const payload = {
      project_name: '前台真验-animal_room-barrier-main',
      report_number: 'PDJC-BG2026-19WEB-AR-MAIN',
      client_name: '前台真验客户',
      ...
      rooms: [{
        ...
        params: {
          temperature: { values: ['29'], result: '不合格' },
          humidity: { values: ['75'], result: '不合格' }
        },
        summary: {
          result_state: '不合格',
