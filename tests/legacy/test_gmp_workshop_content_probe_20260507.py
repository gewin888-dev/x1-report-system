...
OUT_DIR = BASE_DIR / 'reports_x1' / 'gmp_workshop_probe_20260507'
...
COMMON = {
    'project_name': 'GMP终验项目',
    'report_number': 'GMP-20260507-001',
    'client_name': '上海测试制药车间',
    'contact_info': '13912345678',
    'project_address': '上海市制药工业园8号',
    'inspection_area': 'GMP检测区',
