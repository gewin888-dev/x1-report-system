#!/usr/bin/env python3
"""
动物房内容级抽样终验（2026-05-07）
直接生成 filled.docx，并检查基础字段是否真正写入。
"""
import json
import sys
...
OUT_DIR = BASE_DIR / 'reports_x1' / 'animal_room_probe_20260507'
...
CASES = [
    ...
    {
        'case_id': 'barrier_aux_clean_corridor',
        'label': '屏障环境洁净走廊',
        'level_name': '屏障环境',
        'room_name': '洁净走廊',
...
COMMON = {
    'project_name': '动物房终验项目',
    'report_number': 'AR-20260507-001',
    'client_name': '上海测试动物中心',
    'contact_info': '13912345678',
    'project_address': '上海市浦东新区动物实验路99号',
    'inspection_area': '动物房检测区',
