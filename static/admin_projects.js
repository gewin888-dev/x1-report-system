...
function getProjectGroupHint(key){ const map={ active:'进行中：未同时满足“检测完成 + 报告已出报告/历史终态 + 已开票/无需开票”的项目，均归入此组。客户已确认但未出报告，也仍在进行中。', receivable:'待收款：已满足“检测完成 + 报告完成 + 开票完成”，但应收款大于 0 的项目。', done:'已完结：已满足“检测完成 + 报告完成 + 开票完成”，且应收款小于等于 0 的项目。' }; return map[key]||''; }
