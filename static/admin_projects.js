...
function renderProjectSummary(summary){ const box=document.getElementById('project-summary-cards'); if(!box) return; const ra=summary.receivable_amount||0; box.innerHTML=`<div class="stat-cards" style="grid-template-columns:repeat(8,minmax(0,1fr));gap:10px;"><div class="stat-card blue"><div class="label">项目总数</div><div class="value">${summary.project_count||0}</div></div><div class="stat-card orange"><div class="label">检测中</div><div class="value">${summary.detecting_count||0}</div></div><div class="stat-card purple"><div class="label">待出报告</div><div class="value">${summary.pending_report_count||0}</div></div><div class="stat-card blue"><div class="label">未开票</div><div class="value">${summary.pending_invoice_count||0}</div></div><div class="stat-card orange"><div class="label">待回款</div><div class="value">${summary.pending_payment_count||0}</div></div><div class="stat-card green"><div class="label">合同总额</div><div class="value">${formatMoney(summary.contract_total||0)}</div></div><div class="stat-card" style="border-left:4px solid #cf1322;"><div class="label">应收款</div><div class="value" style="color:${ra>0?'#cf1322':'#389e0d'};">${formatMoney(ra)}</div></div><div class="stat-card"><div class="label">已完成</div><div class="value">${summary.done_count||0}</div></div></div>`; }
