...
OUT_JSON = BASE_DIR / 'logs_x1' / 'gmp_workshop_sentinel_20260507.json'

CASES = [
    {'case_id': 'grade_a', 'label': 'A级', 'level_name': 'A级', 'room_name': 'A级配液间', 'context': {'gmp_grade': 'A级'}, 'expected_semantic_key': 'pharma.gmp_workshop.grade.a', 'expected_template_key': 'pharma/gmp_workshop/grade/a'},
    {'case_id': 'grade_b', 'label': 'B级', 'level_name': 'B级', 'room_name': 'B级灌装间', 'context': {'gmp_grade': 'B级'}, 'expected_semantic_key': 'pharma.gmp_workshop.grade.b', 'expected_template_key': 'pharma/gmp_workshop/grade/b'},
    {'case_id': 'grade_c', 'label': 'C级', 'level_name': 'C级', 'room_name': 'C级配制间', 'context': {'gmp_grade': 'C级'}, 'expected_semantic_key': 'pharma.gmp_workshop.grade.c', 'expected_template_key': 'pharma/gmp_workshop/grade/c'},
    {'case_id': 'grade_d', 'label': 'D级', 'level_name': 'D级', 'room_name': 'D级准备间', 'context': {'gmp_grade': 'D级'}, 'expected_semantic_key': 'pharma.gmp_workshop.grade.d', 'expected_template_key': 'pharma/gmp_workshop/grade/d'},
]


def build_project(case):
    return {
        'project_name': f"GMP哨兵-{case['case_id']}",
        'report_number': f"GMP-SENTINEL-{case['case_id']}",
        'client_name': '测试制药车间',
        'contact_info': '13800000000',
        'project_address': '上海市制药工业园',
        'inspection_area': 'GMP哨兵区',
