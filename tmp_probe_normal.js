...
(async () => {
  ...
  const stamp='20260503_1819_normal';
  ...
  const saveRes = await page.evaluate(async () => {
    const payload = {
      project_name: '前台真验-animal_room-normal',
      report_number: 'PDJC-BG2026-19WEB-NORMAL',
      client_name: '前台真验客户',
      ...
      rooms: [{
        ...
        level_name: '普通环境',
        clean_class: '普通环境',
        context: { barrier_room_class: '', barrier_aux_room: '' },
        barrier_room_class: '',
        barrier_aux_room: '',
        basis: ['GB 14925-2023'],
        ...
        params: {
          temperature_aux: { values: ['26'], result: '不合格' },
          humidity_aux: { values: ['60'], result: '不合格' }
        },
        summary: {
          result_state: '不合格',
          ...
          abnormal_items: [
            { key: 'temperature', value: 26, range: '20~26℃', passed: false },
            { key: 'humidity', value: 60, range: '40~70%', passed: false }
          ]
        }
      }],
      inspector: 'admin'
