...
(async () => {
  ...
  const stamp='20260503_1819_barrier_main';
  ...
  const saveRes = await page.evaluate(async () => {
    const payload = {
      project_name: '前台真验-animal_room-barrier_main',
      report_number: 'PDJC-BG2026-19WEB-BARRIER_MAIN',
      client_name: '前台真验客户',
      ...
      rooms: [{
        id: 'r1',
        name: '前台真验动物房-barrier_main',
        type_id: 'animal_room',
        type_name: '动物房',
        level_name: '屏障环境',
        clean_class: '屏障环境',
        context: { barrier_room_class: '主房间', barrier_aux_room: '' },
        ...
        params: {
          temperature_aux: { values: ['29'], result: '不合格' },
          humidity_aux: { values: ['75'], result: '不合格' }
        },
        summary: {
          result_state: '不合格',
          ...
          abnormal_items: [
            { key: 'temperature', value: 29, range: '20~26℃', passed: false },
            { key: 'humidity', value: 75, range: '40~70%', passed: false }
          ]
        }
      }],
      inspector: 'admin'
