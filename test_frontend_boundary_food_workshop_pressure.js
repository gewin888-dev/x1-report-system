...
(async () => {
  ...
  const cases = [
    { id: 'food_pressure_low_out', val: '9', expectPass: false },
    { id: 'food_pressure_eq', val: '10', expectPass: true },
    { id: 'food_pressure_high_in', val: '11', expectPass: true },
  ];
    ...
    const saveRes = await page.evaluate(async (c) => {
      const payload = {
        ...
        rooms: [{
          ...
          judgement: ['GB 50687-2011'], judgement_checked: ['GB 50687-2011'],
          judgement_active: ['GB 50687-2011'], judgement_priority: ['GB 50687-2011'],
          params: {
            pressure: { pairs: [{ refRoom: '相对房间1', range: '≥10', values: [c.val] }], primarySummary: `相对房间1:${c.val}.0 Pa[手动:≥10]`, result: '' }
          },
          summary: {
  ...
  const jsonPath = path.join(OUT, `frontend_boundary_food_workshop_pressure_${stamp}.json`);
